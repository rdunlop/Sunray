...
#define WHEEL_DIAMETER        350        // wheel diameter (mm)
...
// Arduino Due programming port => choose Serial
  ...
  #define CONSOLE Serial   // Arduino Due: do not change (used for Due native USB serial console)
#elif __SAMD51__
...
#define SERIAL_BUFFER_SIZE 350 // was 2048
